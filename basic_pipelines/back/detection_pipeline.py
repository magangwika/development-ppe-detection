...
class GStreamerDetectionApp(GStreamerApp):
    def __init__(self, app_callback, user_data):
        ...
        parser.add_argument(
            "--rtsp-uri",
            default=None,
            help="RTSP URI to stream video from",
        )
    ...
    def get_pipeline_string(self):
        ...
        if self.rtsp_uri:
            source_pipeline = (
                ...
                f"video/x-raw,width={self.network_width},height={self.network_height},format={self.network_format} "
            )
        else:
